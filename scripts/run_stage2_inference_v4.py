"""
Same as run_stage2_inference_v3.py, but points at the v4 checkpoint (trained
with increased network capacity -- model_channels 32->64, channel_mult
[1,2]->[1,2,4], num_res_blocks 1->2 -- everything else identical to v1: plain
GT footprint, no classifier-free dropout, no attention. See PROGRESS.md
"Not yet tried" list / capacity theory.

Usage:
    python scripts/run_stage2_inference_v4.py
"""
import sys
