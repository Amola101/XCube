"""
Saves one combined grid image comparing TEUNet input / Stage 2 output / ground
truth across multiple samples at once (e.g. one from each difficulty tier).

Usage:
    python scripts/visualize_stage2_multi.py [idx1 idx2 idx3 ...]

Each idx is a test-set index, 0-197 (0-125 = "good", 126-171 = "moderate",
172-197 = "poor"). Defaults to one representative sample per tier if no
indices are given: 60 (good), 140 (moderate), 185 (poor).
"""
import sys
...
col_titles = ['TEUNet Input (flawed)', 'XCube Stage 2 Output', 'Ground Truth']
...
plt.tight_layout()
out_path = '/home/ameliacatala/Documents/stage2_visual_comparison_multi.png'
